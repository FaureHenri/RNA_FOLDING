...
def load_sequences_and_targets(data_path, in_cols, out_cols, qc_level=1.1, analysis=False):
    ...
    if analysis:
        toehold_df = data[['source_sequence', 'seq_SwitchON_GFP']]
        return toehold_df, df_data_output
    else:
