...
class RNADataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        rna_seq = rna_seq.reshape(-1, 1)

        return rna_seq, self.rna_labs[idx]
...
class LitLSTM(pl.LightningModule):
    ...
    def __init__(self, batch):
        ...
        self.lit_layers = LSTM_NN(filters=[148*4, 128, 100, 1], dropout=0.3)
        self.best_r2 = -np.inf
...
def train_main_lstm(config):
    ...
    ribonet = LitLSTM(batch=config.batch_size)
