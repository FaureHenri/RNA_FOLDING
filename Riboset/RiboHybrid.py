"""
Build database with RNA encoded as GRAPH and Tensor (148*148*16)
nodes: 148 nucleotides (4 features) one-hot encoded nucleotide
...
from Utils.graph_encoder.hybrid_utils import get_graph_structure
...
class RIBORNA(Dataset):
    ...
    def process(self):
        for file in tqdm(self.files):
            node_features, edge_index, mat, label = get_graph_structure(self.df, osp.join(self.raw_dir, file))
...
if __name__ == "__main__":
    ...
    root_processed = '/media/sdd/hfaure/riboset/RiboHybrid2'
