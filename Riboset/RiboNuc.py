...
from Utils.graph_encoder.nuc_utils import get_graph_structure
...
class RIBORNA(Dataset):
    ...
    def process(self):
        for file in tqdm(self.files):
            node_features, edge_index, edge_weight, label = get_graph_structure(self.df, osp.join(self.raw_dir, file))
...
if __name__ == "__main__":
    ...
    root_processed = '/media/sdd/hfaure/riboset/RiboNuc'
