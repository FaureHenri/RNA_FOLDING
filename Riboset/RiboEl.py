...
nodes: Elements (6 features) one-hot encoded element
...
from Utils.graph_encoder.el_utils import get_graph_structure
...
if __name__ == "__main__":
    ...
    root_processed = '/media/sdd/hfaure/riboset/RiboEl'
