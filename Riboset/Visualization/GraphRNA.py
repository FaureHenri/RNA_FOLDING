...
# saved directory
id_num = input('Enter Toehold ID num: ')
dirname = id_num + '_Toehold'
dirpath = join('RNA_SS', dirname)
if not os.path.isdir(dirpath):
    mkdir(dirpath)

df_toehold = pd.read_csv('/rds/general/user/hf721/home/RNA_FOLDING/DATA/Toehold_Dataset_Final_2019-10-23.csv')
# The RNA sequence
# raw_seq = input('Enter the 1D RNA sequence in ON state: ')
raw_seq = df_toehold.iloc[int(id_num)]['seq_SwitchON_GFP']
